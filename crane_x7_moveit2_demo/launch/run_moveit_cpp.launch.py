...
def generate_launch_description():
    ...
    robot_description_config = load_file('crane_x7_description', 'urdf/crane_x7.urdf')
    robot_description = {'robot_description' : robot_description_config}

    robot_description_semantic_config = load_file('crane_x7_moveit_config', 'config/crane_x7.srdf')
    ...
    fake_joint_driver_node = Node(package='fake_joint_driver',
                                  ...
                                  parameters=[{'controller_name': 'crane_x7_controller'},
                                              os.path.join(get_package_share_directory("run_moveit_cpp"), "config", "crane_x7_controllers.yaml"),
